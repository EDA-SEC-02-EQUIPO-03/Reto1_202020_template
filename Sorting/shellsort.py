    ...
    while (h >= 1):
        for i in range (h,n):
            ...
            while (j>=h) and function (lt.getElement(lst,j+1),lt.getElement(lst,j-h+1),condition):
                ...
                j -=h
        h //=3              # h se decrementa en un tercio. cuando h es igual a 1, se comporta como insertionsort            # h se decrementa en un tercio. cuando h es igual a 1, se comporta como insertionsort